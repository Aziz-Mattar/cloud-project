      ...
      <div class="container-scroller">
         <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
               <a class="navbar-brand brand-logo" href="index2.php"><img src="assets/images/logo.svg" alt="logo" /></a>
               <a class="navbar-brand brand-logo-mini" href="index2.php"><img src="assets/images/logo-mini.svg" alt="logo" /></a>
            </div>
      ...
      <li class="nav-item">
         ...
         <div class="collapse" id="A">
            <ul class="nav flex-column sub-menu">
               <li class="nav-item"> <a class="nav-link" href="pages/samples/Add2 - Copy.php">Add Courses</a></li>
               <li class="nav-item"> <a class="nav-link" href="pages/samples/Add3 - Copy.php">Add financial data</a></li>
            </ul>
         </div>
      </li>
      <li class="nav-item">
         ...
         <div class="collapse" id="B">
            <ul class="nav flex-column sub-menu">
               <li class="nav-item"> <a class="nav-link" href="pages/samples/Delete - Copy.php">Delete </a></li>
            </ul>
         </div>
      </li>
      <li class="nav-item">
         ...
         <div class="collapse" id="C">
            <ul class="nav flex-column sub-menu">
               <li class="nav-item"> <a class="nav-link" href="pages/samples/otherPage - Copy.php"> view </a></li>
            </ul>
         </div>
      </li>
      <li class="nav-item">
         ...
         <div class="collapse" id="D">
            <ul class="nav flex-column sub-menu">
               <li class="nav-item"> <a class="nav-link" href="pages/samples/View2 - Copy.php"> Search </a></li>
            </ul>
         </div>
      </li>
                  </li>
