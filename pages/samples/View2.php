         ...
         <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
               <div class="content-wrapper containerA">
                  <form method="post" action="otherPage2.php">
                     <div class="row">
                        <div class="col-12 grid-margin">
                           <div class="card" style="width: fit-content;">
                              <div class="card-body">
                                 <h1 class="text-center">Select Student ID And What You Want To Search For</h1>
                                    ...
                                    <table class="table">
                                       <tr>
                                          ...
                                          <td><select id="type" name="ID">
                                             ...
                                             <?php require 'Control/View2C.php'; ?>                          
                                             </select>
                                          </td>
                                       </tr>
                                       <tr>
                                          ...
                                          <td>
                                             <select id="type" name="Search">
                                                <option value="personal_information">Student Personal Information</option>
                                                <option value="grades">Student Grades</option>
                                                <option value="financial_data">Student Financial Data</option>
                                             </select>
                                          </td>
                                       </tr>
                                       <tr>
