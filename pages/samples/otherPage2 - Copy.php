   ...
   <body>
      <div class="containerA" >
         <?php
                    ...
                    for ($j = 1; $j < 3; $j++) {
                        ...
                        if (mysqli_num_rows($result1) > 0) {
                            echo "<table class='table' class='invisible-scrollbar'>
                                              <tr><td><h2> Year $i</h2></td> <td><h2>Semester $j</h2></td>
                                              <tr><td>Total Amount: </td> <td>Paid Amount: </td><td><b>Remained Amount: </b></td></tr>";
                            while ($row = mysqli_fetch_assoc($result1)) {
                                echo "<tr><td>" . $row['total_amount'] . "</td> <td>" . $row['paid_amount'] . "</td><td><b>" . $row['Remained_amount'] . "</b></td></tr>";
                            }
                        }
                    }
                }
            ...
            } elseif ($Search == 'personal_information') {
                echo "
                    ...
                    for ($j = 1; $j < 3; $j++) {
                        ...
                        if (mysqli_num_rows($result1) > 0) {
                            ...
                            echo "<table class='table'>
                                                <tr><td><h2> Year $i</h2></td>
                                                 <td><h2>Semester $j</h2></td>
                                                 <tr><td>Course Name: </td> 
                                                 <td>Course Grade: </td></tr>";
                            while ($row = mysqli_fetch_assoc($result1)) {
                                echo "<tr><td>" . $row['course_name'] . "</td> <td>" . $row['course_grade'] . "</td></tr>";
                            }
                            echo "<tr><td><b>GPA: </b></td> <td><b>" . $row2[0] . "</b></td> </tr>";
                        }
                    }
                }
                echo "</table>
